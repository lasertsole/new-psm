...
import com.psm.domain.Independent.Model.Joint.models_user.pojo.entity.ModelUserDO;
...
@Slf4j
@Repository
@CacheConfig(cacheNames = "models_UserCache")
public class Models_UserDBImpl implements Models_UserDB {
    ...
    @Override
    @Cacheable(key = "#current+'_'+#isIdle+'_'+#canUrgent+'_'+#style+'_'+#type+'_'+#userSelfId+'_'+#size")
