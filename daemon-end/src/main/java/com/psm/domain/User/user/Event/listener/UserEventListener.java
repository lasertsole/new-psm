                ...
                .setMessageListener(messageView -> {
                    ...
                    switch (tag) {
                        case "socketLogin":
                            ...
                            SocketLoginEvent socketLoginEvent = JSON.parseObject(jsonString, SocketLoginEvent.class);
                            userService.forwardSocketLogin(socketLoginEvent.getUserId(), socketLoginEvent.getIp());
                            break;
                        default:
