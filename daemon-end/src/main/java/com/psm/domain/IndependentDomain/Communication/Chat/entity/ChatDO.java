package com.psm.domain.IndependentDomain.Communication.Chat.entity;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.psm.domain.IndependentDomain.Communication.Chat.types.convertor.ChatConvertor;
import com.psm.domain.IndependentDomain.User.user.entity.User.UserDO;
import com.psm.domain.IndependentDomain.User.user.entity.User.UserDODefine;
